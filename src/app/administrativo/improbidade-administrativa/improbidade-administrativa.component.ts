...
export class ImprobidadeAdministrativaComponent implements OnInit {
  ...
  formatarParagrafo(paragrafo: string): string {
    ...
    resultado = resultado.replace(/(Seção III  Dos Atos de Improbidade Administrativa que Atentam Contra os Princípios da Administração Pública)/g, '</br></br><h6 class="leiClass">$1</h6>');
