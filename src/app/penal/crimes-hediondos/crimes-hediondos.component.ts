...
export class CrimesHediondosComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.analyticsService.trackEvent('CodigoPenal-Crimes-Hediondos', 'CodigoPenal-Crimes-Hediondos into view');
    this.loading = true;
  ...
  formatarParagrafo(paragrafo: string): string {
    ...
    resultado = resultado.replace(/(LEI Nº 8 . 072, DE 25 DE JULHO DE 1990 .)/g, '<h6 class="leiClass">$1</h6>');
    return resultado;
  }
